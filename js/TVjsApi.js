var TVjsApi = (function () {
    ...
    this.socket.on("open", function () {
      ...
      if (that.interval < 60) {
        ...
        that.socket.send({
          cmd: "req",
          args: [
            "candle.H" + that.interval / 60 + "." + symbol,
            150,
            parseInt(Date.now() / 1000),
          ],
          id: "1366",
          ...
          (function (button) {
            thats
              ...
              .on("click", function (e) {
                ...
                var $active =
                  this.parentNode.parentNode.querySelector(".active");
  ...
  TVjsApi.prototype.subscribe = function () {
    if (this.interval < 60) {
      ...
      this.sendMessage({
        cmd: "sub",
        args: [
          "candle.H" + this.interval / 60 + "." + this.symbol.toLowerCase(),
        ],
      });
    } else {
      this.sendMessage({
  ...
  TVjsApi.prototype.initMessage = function (
    symbolInfo,
    resolution,
    rangeStartDate,
    rangeEndDate,
  ...
  TVjsApi.prototype.initLimit = function (
    resolution,
    rangeStartDate,
    rangeEndDate
  ) {
